...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $mail->SetFrom('crazyegg123456@gmail.com', 'Crazy Egg');
    ...
    foreach($_SESSION['cart'] as $i => $k) {
        $linha = $k->descricao.'     '.$k->preco.'€'.PHP_EOL;
        @$total=$total+$k->preco;
        fwrite($ficheiro, $linha);
    ...
    if(!$mail->Send()) {
       ...
       <div class=fundo>  
         ...
         <li style=float:right><a href=catalogo.php?tipo=1>Catalogo</a></li>
         ...
         echo "<br><br>";
         echo "<a class='w3-button w3-pale-red' href=catalogo.php?tipo=1>Voltar</a>";
